...
int main() {
    ...
    vector<string> move_log_first_yy = move_y(N, C2);
    vector<string> move_log_first_yx = move_x(N, C2);
    vector<string> move_log_first_yothers = move_others(N, C2);

    if (move_log_first_xx.size() + move_log_first_xy.size() +
            move_log_first_xothers.size() <
        move_log_first_yy.size() + move_log_first_yx.size() +
            move_log_first_yothers.size()) {
        ...
        for (auto &s : move_log_first_yy) {
            cout << s << endl;
        }
        for (auto &s : move_log_first_yx) {
            cout << s << endl;
        }
        for (auto &s : move_log_first_yothers) {
            cout << s << endl;
        }
    }
